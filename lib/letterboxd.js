...
var config = require('../config/letterboxd');

const baseUrl = config.baseUrl;
const spoilerText = config.spoilerText;
...
module.exports = function getDiaryData(username, callback) {
